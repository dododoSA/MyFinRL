...
# こういう訓練済みモデルのディレクトリの設定の仕方もある(実行するごとにディレクトリを作るからめっちゃたくさんになっちゃいそう)
# now = datetime.datetime.now()
# TRAINED_MODEL_DIR = f"trained_models/{now}"
# 一応フォーマット済み文字列リテラルで定義されているので日付などで分けることができる
...
# モデルのパラメータ デフォルトの値を忘れたくないからいじらない方がいいかも
## Model Parameters
